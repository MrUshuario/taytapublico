...
import 'package:tayta/viewmodels/UI/opciones/menu_visitaPresencial_fallecido.dart';
...
class MenuVisitaPresencial extends StatefulWidget {
  ...
  Visitas? formData;
  MenuVisitaPresencial(this.listMediaPath, this.formData, {super.key});
...
class _MenuVisitaPresencial extends State<MenuVisitaPresencial> {
                  ...
                  Radio<EstadoFallecido>(
                    ...
                    onChanged: (EstadoFallecido? value) {
                      setState(() {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  MenuVisitaPresencialFallecido(List.empty(growable: true), Visitas())),
                        );
